...
def ts_bronze():
    phone_accel_df = (
        ...
        .withColumn(
            "event_ts", (col("Arrival_Time").cast("double") / 1000).cast("timestamp")
        )
...
@dlt.table(
    comment="Fourier Transform of the Input time series dataframe",
    table_properties={"quality": "silver", "pipelines.autoOptimize.zOrderCols": "freq"},
)
