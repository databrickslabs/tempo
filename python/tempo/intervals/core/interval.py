...
class Interval:
    ...
    def update_start(
        ...
        return Interval(
            new_data, self.boundary_accessor, self.series_fields, self.metric_fields
        )
    ...
    def validate_metrics_alignment(self, other: "Interval") -> ValidationResult:
        ...
        return self._validate_column_alignment(
            self.metric_fields, other.metric_fields, "metric_fields"
        )
    ...
    def validate_series_alignment(self, other: "Interval") -> ValidationResult:
        ...
        return self._validate_column_alignment(
            self.series_fields, other.series_fields, "series_fields"
        )
    ...
    def _validate_column_alignment(
        ...
        if set(self_columns) != set(other_columns):
            if column_type == "metric_fields":
                raise InvalidMetricColumnError(error_message)
            elif column_type == "series_fields":
                raise InvalidSeriesColumnError(error_message)
            else:
