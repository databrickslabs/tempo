...
def test_invalid_inputs(input_string):
    ...
    try:
        ...
        pytest.fail(
            f"Function raised {type(e).__name__} for input '{input_string}': {e}"
        )
